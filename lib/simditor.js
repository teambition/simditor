...
Simditor = (function(superClass) {
  ...
  function Simditor(opts) {
    if (opts != null ? opts.language : void 0) {
      this.constructor.locale = opts.language;
    }
...
LinkButton = (function(superClass) {
  ...
  LinkButton.prototype.status = function($node) {
    ...
    showPopover = true;
    if ($node.is(this.htmlTag) && $node.is('[rel=nofollow]')) {
      text = $node.text();
...
LinkPopover = (function(superClass) {
  ...
  LinkPopover.prototype.render = function() {
    ...
    this.textEl.on('keyup', (function(_this) {
      return function(e) {
        ...
        isSame = _this.urlEl.val() === _this.formatUrl(_this.textEl.val());
        return _this.target[isSame ? 'attr' : 'removeAttr']('rel', 'nofollow');
      };
    })(this));
    this.urlEl.on('keyup', (function(_this) {
      return function(e) {
        ...
        val = _this.urlEl.val();
        val = _this.formatUrl(val);
        isSame = val === _this.formatUrl(_this.textEl.val());
  ...
  LinkPopover.prototype.formatUrl = function(url) {
